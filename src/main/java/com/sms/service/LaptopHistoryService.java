...
public class LaptopHistoryService {
	...
	/*
	 * // Old method if needed public List<LaptopHistory> getAllHistories() { return
	 * laptopHistoryRepository.findAll(); }
	 */
	public void deleteHistory(Long id) {
		laptopHistoryRepository.deleteById(id);
	}

	public List<LaptopHistory> getHistoriesByStudentId(Long studentId) {
		return laptopHistoryRepository.findByStudent_Id(studentId);
	}
